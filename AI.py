...
"""
runner = pyttsx3.init()
voices = runner.getProperty('name')
...
if __name__ == '__main__':
    ...
    while True:
        ...
        if 'tell me a joke' in message:
            ...
            speak("Now initializing the Security mode")
            secure()
            ...
            result = wikipedia.summary(message, sentence=2)
